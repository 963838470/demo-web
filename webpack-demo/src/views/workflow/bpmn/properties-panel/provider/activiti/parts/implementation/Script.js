...
module.exports = function(
  ...
  return {
    template:
      ...
      '<input type="text" name="scriptFormat" />' +
      ...
      '</label>' +
      '<div class="bpp-field-wrapper">' +
      '<select name="scriptType" data-value>' +
      ...
      '<input type="text" name="scriptResourceValue" />' +
      ...
      '<textarea type="text" name="scriptValue"></textarea>' +
      '</div>' +
      '</div>',
