!(function(window) {
  ...
  (function(JTopo) {
    ...
    function getDistance(a, b, c, d) {
      var e, f
      return (
        null == c && null == d ? ((e = b.x - a.x), (f = b.y - a.y)) : ((e = c - a), (f = d - b)),
        Math.sqrt(e * e + f * f)
      )
    }
    function getElementsBound(a) {
      for (
        var b = { left: Number.MAX_VALUE, right: Number.MIN_VALUE, top: Number.MAX_VALUE, bottom: Number.MIN_VALUE },
          c = 0;
        c < a.length;
        c++
      ) {
    ...
    function randomColor() {
      return (
        Math.floor(255 * Math.random()) + "," + Math.floor(255 * Math.random()) + "," + Math.floor(255 * Math.random())
      )
    }
    function isIntsect() {}
    ...
    function intersection(a, b) {
      ...
      return a.k == b.k
        ...
        : (1 / 0 == a.k || a.k == -1 / 0
          ...
          0 == isPointInLineSeg(c, d, a) ? null : 0 == isPointInLineSeg(c, d, b) ? null : { x: c, y: d })
    }
      ...
      return {
        ...
        getImage: function(b, c) {
          ...
          ;(this.exportCanvas.width = a.canvas.width),
            ...
            null != b && null != c
              ? ((this.exportCanvas.width = b), (this.exportCanvas.height = c), (e = b / d.width), (f = c / d.height))
        ...
        eventHandler: function(a, b, c) {
          ...
          if (d > c.canvas.width - this.canvas.width && e > c.canvas.height - this.canvas.height) {
            if (
              ...
              "mousedown" == a &&
                ((this.lastTranslateX = c.childs[0].translateX), (this.lastTranslateY = c.childs[0].translateY)),
    ...
    function c(c) {
      ...
      function i(a) {
        ...
        n.mouseDown
          ...
          : (n.dispatchEventToScenes("mousemove", b), n.dispatchEvent("mousemove", b))
      }
      function j(a) {
        var b = d(a)
      ...
      function l(a) {
        ...
        n.dispatchEventToScenes("mousewheel", b),
          ...
          null != n.wheelZoom &&
            (a.preventDefault ? a.preventDefault() : ((a = a || window.event), (a.returnValue = !1)),
            1 == n.eagleEye.visible && n.eagleEye.update())
      }
      function m(b) {
      ...
      q.forEach(function(a) {
        ...
        (this.repaint = function() {
          0 != this.frames &&
            ((this.frames < 0 && 0 == this.needRepaint) || (this.paint(), this.frames < 0 && (this.needRepaint = !1)))
        }),
          ...
          if (this.image) {
            ...
            a.beginPath(),
              ...
              null == this.borderRadius || 0 == this.borderRadius
                ? a.rect(-this.width / 2, -this.height / 2, this.width, this.height)
                : a.JTopoRoundRect(-this.width / 2, -this.height / 2, this.width, this.height, this.borderRadius),
              a.fill(),
              a.closePath()
        ...
        (this.getTextPostion = function(a, b, c) {
          ...
          return (
            null == a || "Bottom_Center" == a
              ? (d = { x: -this.width / 2 + (this.width - b) / 2, y: this.height / 2 + c })
              : "Top_Center" == a
                ? (d = { x: -this.width / 2 + (this.width - b) / 2, y: -this.height / 2 - c / 2 })
                : "Top_Right" == a
                      ...
                      : "Bottom_Left" == a
                        ...
                        : "Middle_Center" == a
                          ...
                          : "Middle_Right" == a
                            ...
                            : "Middle_Left" == a && (d = { x: -this.width / 2 - b, y: c / 2 }),
      ...
      this.initialize(),
        ...
        (this.paint = function(a) {
          a.beginPath(),
            ...
            a.fillText(this.text, -this.width / 2, this.height / 2),
            this.isMouseOver &&
              (a.moveTo(-this.width / 2, this.height), a.lineTo(this.width / 2, this.height), a.stroke()),
            a.closePath(),
            this.paintBorder(a),
            this.paintCtrl(a),
            this.paintAlarmText(a)
    ...
    function f(b, c, g) {
      ...
      ;(this.initialize = function(b, c, d) {
        ...
        (this.getPath = function() {
          ...
          return (
            (m = { x: m.x + k * Math.cos(i - Math.PI), y: m.y + k * Math.sin(i - Math.PI) }),
            (n = { x: n.x + k * Math.cos(j - Math.PI), y: n.y + k * Math.sin(j - Math.PI) }),
            a.push({ x: b.x, y: b.y }),
            a.push({ x: m.x, y: m.y }),
            a.push({ x: n.x, y: n.y }),
            a.push({ x: c.x, y: c.y }),
      ...
      ;(this.initialize = function() {
        ...
        (this.getEndPosition = function() {
          ...
          return (
            "horizontal" == this.direction
              ? (a.x = this.nodeA.cx < a.x ? this.nodeZ.x : this.nodeZ.x + this.nodeZ.width)
              : (a.y = this.nodeA.cy < a.y ? this.nodeZ.y : this.nodeZ.y + this.nodeZ.height),
            a
          )
        }),
        (this.getPath = function(a) {
                      ...
                      : "Bottom_Left" == a
                        ...
                        : "Middle_Center" == a
                          ...
                          : "Middle_Right" == a
                            ...
                            : "Middle_Left" == a && (d = { x: this.x, y: this.y + this.height / 2 + c / 2 }),
            null != this.textOffsetX && (d.x += this.textOffsetX),
            null != this.textOffsetY && (d.y += this.textOffsetY),
            d
          )
  ...
  (function(a) {
    ...
    function o(a, b, c, d, e, f) {
      var g = f || "bottom",
        h = []
      if ("bottom" == g) for (var i = a - (c / 2) * d + d / 2, j = 0; c >= j; j++) h.push({ x: i + j * d, y: b + e })
      else if ("top" == g) for (var i = a - (c / 2) * d + d / 2, j = 0; c >= j; j++) h.push({ x: i + j * d, y: b - e })
      else if ("right" == g)
        ...
        return (
          (g = setInterval(function() {
            return o
              ? void h.stop()
              : ((i += f),
                void (a.y + a.height < e.stage.canvas.height ? a.setLocation(a.x + d, a.y + i) : ((i = 0), c())))
          }, 20)),
          h
        )
      }
          ...
          (h = setInterval(function() {
            return o
              ...
              : ((a.vy += f),
                ...
                (a.y += a.vy),
                void (
                  (a.x < 0 || a.x > g.stage.canvas.width || a.y > g.stage.canvas.height) &&
    ...
    function b(a, b) {
      ...
      if (null != d) {
        ...
        if (
          ...
          (null == d || d.length < 5) &&
            ((d = b.match(/\s*(\w+)\s*\[\s*(\w+)\s*([>=<])\s*(\d+(\.\d+)?)\s*\]\s*/)), (f = !0)),
          null != d && d.length >= 5)
        ) {
          var g = d[1],
            h = d[2],
